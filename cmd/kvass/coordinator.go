...
func init() {
	...
	coordinatorCmd.Flags().Int64Var(&cdCfg.shardMaxBodySizeMB, "shard.max-body-size-mb", 1024*1024*1024,
		"max body size of per target, unit is MB")
		...
		var (
			...
			cd = coordinator.NewCoordinator(
				&coordinator.Option{
					...
					MaxBodySize:                  cdCfg.shardMaxBodySizeMB * 1024 * 1024,
